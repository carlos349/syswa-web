...
class Mails {
    ...
    public function suscriptionMail(){
        ...
        //cuerpo del email:
        $cuerpoMensaje = "El cliente:".$firtName." ".$lastName." se ha suscrito<br>";
        ...
        try {
            ...
            $mailTwo = new PHPMailer(true);
                ...
                try {
                    ...
                    $mailTwo->addAddress($destinatarioEmailTwo, 'Cliente');     // Add a recipient
