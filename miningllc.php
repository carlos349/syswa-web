			...
			<div class="container">
				<div class="row">
					<div class="col-lg-4 portfolio_title_container">
						...
						<h2 class="portfolio_title">miningllc.com</h2>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-8 order-lg-1 order-2">
						<p class="portfolio_text">Desarrollo de un pagina web landing, siempre adaptandonos a las necesidades de nuestros clientes.</p>
					</div>
					<div class="col-lg-4 order-lg-3 order-1">
						<div class="portfolio_info_box">
							...
							<ul class="info_box_item">
								...
								<li class="info_box_content">Septiembre 2018</li>
							</ul>
