			...
			<div class="row fill_height">
				...
				<div class="col-lg-6 v_slider_section_image">
					<div class="v_slider_image">
						<img src="views/images/testimonials.jpg" alt="">
					</div>
				</div>
				...
				<div class="col-lg-5 offset-lg-1 v_slider_content d-flex flex-column justify-content-center">
					...
					<div class="v_slider_title">
						<h1 style="color: #fff;">Lo que nuestros clientes dicen</h1>
					</div>
						...
						<div class="v_slider">
							...
							<div class="v_slider_item">
								...
								<div class="person d-flex flex-row">
									...
									<div class="person_meta">
										<div class="person_name" style="color: #fff;">Leoximar </div>
			...
			<div class="owl-carousel owl-theme clients_slider">
				...
				<div class="owl-item clients_item">
					<div class="client_item_background trans_200">
						<img src="views/images/client_1.png" alt="">
					</div>
				</div>
				...
				<div class="owl-item clients_item">
					<div class="client_item_background trans_200">
						<img src="views/images/client_2.png" alt="">
					</div>
				</div>
				...
				<div class="owl-item clients_item">
					<div class="client_item_background trans_200">
						<img src="views/images/client_3.png" alt="">
					</div>
				</div>
				...
				<div class="owl-item clients_item">
					<div class="client_item_background trans_200">
						<img src="views/images/client_4.png" alt="">
					</div>
				</div>
				...
				<div class="owl-item clients_item">
					<div class="client_item_background trans_200">
						<img src="views/images/client_5.png" alt="">
					</div>
				</div>
